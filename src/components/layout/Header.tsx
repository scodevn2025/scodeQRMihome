...
const Header: React.FC<HeaderProps> = ({ onMenuClick, className }) => {
  return (
    <header className={`bg-white/80 backdrop-blur-md border-b border-slate-200/50 shadow-sm ${className}`}>
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="relative hidden md:block">
            ...
            <Input
              ...
              className="pl-10 w-80 bg-white/50 border-slate-200 focus:bg-white focus:border-blue-300"
            />
          </div>
        </div>
            ...
            <DropdownMenuContent align="end" className="w-80">
              ...
              <DropdownMenuItem>
                <div className="flex flex-col space-y-1">
                  ...
                  <p className="text-xs text-slate-500">Xiaomi Air Purifier đã được kết nối</p>
              ...
              <DropdownMenuItem>
                <div className="flex flex-col space-y-1">
                  ...
                  <p className="text-xs text-slate-500">Đăng nhập từ thiết bị mới</p>
              ...
              <DropdownMenuItem>
                <div className="flex flex-col space-y-1">
                  ...
                  <p className="text-xs text-slate-500">Phiên bản mới đã sẵn sàng</p>
