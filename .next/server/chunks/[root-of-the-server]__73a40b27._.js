module.exports = [
"[project]/.next-internal/server/app/api/auth/qr/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uuid$2f$dist$2f$v4$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__default__as__v4$3e$__ = __turbopack_context__.i("[project]/node_modules/uuid/dist/v4.js [app-route] (ecmascript) <export default as v4>");
;
;
;
// Mijia API constants
...
async function getIndexData(deviceId) {
...
async function POST() {
    try {
        ...
        const qrId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uuid$2f$dist$2f$v4$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__default__as__v4$3e$__["v4"])();
        ...
        const qrUrl = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$qrcode$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].toDataURL(qrData.loginUrl, {
            width: 256,
            margin: 2,
            color: {
                dark: '#000000',
...
async function checkQRLoginStatus(session) {
    if (!session.lpUrl) {
    ...
    try {
        ...
        if (retData.userId && retData.ssecurity && retData.location) {
            ...
            return {
                status: 'confirmed',
                token: retData.ssecurity,
                user: {
                    id: retData.userId,
                    username: accountInfo.nickname || `User_${retData.userId}`,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__73a40b27._.js.map