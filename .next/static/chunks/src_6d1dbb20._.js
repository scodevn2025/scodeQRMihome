...
"[project]/src/lib/mijia/types.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/mijia/auth.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class MijiaAuth {
   ...
   */ async QRlogin() {
        try {
            ...
            const qrUrl = "mijia://login?qr_id=".concat(qrData.qr_id, "&timestamp=").concat(qrData.timestamp);
            // Simulate QR scan và login
            // Trong thực tế, cần polling để check QR status
            return {
                success: true,
                token: "qr_token_".concat(qrData.qr_id),
                service_token: "service_token_".concat(qrData.qr_id),
                security_token: "security_token_".concat(qrData.qr_id),
                user_id: 'qr_user',
                user_name: 'QR User',
                user_avatar: null
            };
    ...
    async getCaptcha() {
        try {
            const response = await fetch("".concat(this.baseUrl, "/pass/serviceLoginAuth2"), {
                method: 'POST',
                headers: {
    ...
    async getServiceToken(token) {
        try {
            const response = await fetch("".concat(this.serviceUrl, "/home/device_list"), {
                method: 'POST',
                headers: {
    ...
    constructor(){
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "baseUrl", 'https://account.xiaomi.com');
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "serviceUrl", 'https://api.io.mi.com/app');
    }
}
...
"[project]/src/lib/mijia/api.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class MijiaAPI {
    ...
    async request(endpoint) {
        ...
        var _this_session;
        if (!((_this_session = this.session) === null || _this_session === void 0 ? void 0 : _this_session.service_token)) {
            return {
                success: false,
        ...
        try {
            ...
            const response = await fetch("".concat(this.baseUrl).concat(endpoint), {
                ...
                headers: {
                    ...
                    'Cookie': "PassportDeviceId=".concat(this.session.passport_device_id, ";userId=").concat(this.session.user_id, ";serviceToken=").concat(this.session.service_token, ";"),
                    'Content-Type': 'application/x-www-form-urlencoded',
                    ...options.headers
                },
                body: formData
            ...
            if (responseData.code === 0) {
                ...
                return {
                    success: false,
                    error: "获取数据失败, ".concat(responseData.message)
                };
            }
        } catch (error) {
            return {
    ...
    generateSignature(uri, signedNonce, nonce, data) {
        ...
        const sign = "".concat(uri, "&").concat(signedNonce, "&").concat(nonce, "&data=").concat(data);
        let hash = 0;
   ...
   */ async get_devices_list() {
        ...
        for (const home of homesResponse.data){
            ...
            while(has_more){
                ...
                if (response.success && ((_response_data = response.data) === null || _response_data === void 0 ? void 0 : _response_data.device_info)) {
   ...
   */ async get_homes_list() {
        ...
        if (response.success && ((_response_data = response.data) === null || _response_data === void 0 ? void 0 : _response_data.home_list)) {
            return {
                success: true,
   ...
   */ async get_scenes_list(home_id) {
        ...
        if (response.success && ((_response_data = response.data) === null || _response_data === void 0 ? void 0 : _response_data.scene_info_list)) {
            return {
                success: true,
   ...
   */ async set_devices_prop(device) {
        const properties = Object.entries(device.properties).map((param)=>{
            let [, value] = param;
            return {
                did: device.id,
                siid: 2,
   ...
   */ async update_device(deviceUpdate) {
    ...
    constructor(session){
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "session", null);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "baseUrl", 'https://api.io.mi.com/app');
        if (session) {
            this.session = session;
        }
    }
...
"[project]/src/lib/mijia/device.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class MijiaDeviceWrapper {
    ...
    constructor(api, device){
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "device", void 0);
...
"[project]/src/lib/mijia/index.ts [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";

// Mijia API - Main export file
__turbopack_context__.s([]);
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mijia$2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/mijia/types.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mijia$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/mijia/auth.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mijia$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/mijia/api.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mijia$2f$device$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/mijia/device.ts [app-client] (ecmascript)");
;
;
;
;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mijia$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/lib/mijia/index.ts [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mijia$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/mijia/api.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mijia$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/mijia/auth.ts [app-client] (ecmascript)");
;
...
class ApiClient {
    async request(endpoint) {
        let options = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
        try {
            console.log('🌐 API Client: Making request to:', "".concat(API_BASE, "/api").concat(endpoint));
            console.log('📤 API Client: Request options:', {
                method: options.method || 'GET',
                headers: options.headers
            });
            const response = await fetch("".concat(API_BASE, "/api").concat(endpoint), {
                headers: {
                    'Content-Type': 'application/json',
                    ...options.headers
                },
    ...
    async checkQRStatus(qrId) {
        ...
        try {
            ...
            const result = await this.request("/auth/qr?qr_id=".concat(qrId));
            console.log('📥 API Client: QR status result:', {
                success: result.success,
                status: (_result_data = result.data) === null || _result_data === void 0 ? void 0 : _result_data.status,
                hasToken: !!((_result_data1 = result.data) === null || _result_data1 === void 0 ? void 0 : _result_data1.token),
                hasUser: !!((_result_data2 = result.data) === null || _result_data2 === void 0 ? void 0 : _result_data2.user),
                error: result.error
            });
            return result;
        } catch (error) {
    ...
    async getDevices() {
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mijia$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mijiaAPI"].get_all_devices();
            if (response.success && response.data) {
    ...
    async getHomes() {
        ...
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mijia$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mijiaAPI"].get_homes_list();
    ...
    async getScenes(homeId) {
        ...
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mijia$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mijiaAPI"].get_scenes_list(homeId);
    ...
    async runScene(sceneId) {
        ...
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mijia$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mijiaAPI"].run_scene(sceneId);
            console.log('📥 Mijia API run scene response:', response);
            if (response.success) {
                return {
                    success: true,
                    data: {
                        message: "Scene ".concat(sceneId, " executed successfully")
                    }
                };
            } else {
                return {
    ...
    async getDeviceProperties(deviceId) {
        ...
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mijia$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mijiaAPI"].get_devices_prop({
                did: deviceId
            });
    ...
    async updateDevice(deviceId, properties) {
        ...
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mijia$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mijiaAPI"].update_device({
                device_id: deviceId,
            ...
            if (response.success) {
                return {
                    success: true,
                    data: {
                        message: "Device ".concat(deviceId, " updated successfully")
                    }
                };
            } else {
                return {
    ...
    async executeDeviceAction(deviceId, action) {
        ...
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mijia$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mijiaAPI"].run_action({
                device_id: deviceId,
            ...
            if (response.success) {
                return {
                    success: true,
                    data: {
                        message: "Action ".concat(action.action, " executed successfully on device ").concat(deviceId)
                    }
                };
            } else {
                return {
    ...
    async loginWithCredentials(username, password) {
        ...
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mijia$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mijiaAuth"].login(username, password);
            console.log('📥 Mijia Auth login response:', response);
            if (response.success) {
                // Set session for mijiaAPI
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mijia$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mijiaAPI"].setSession(response.data);
                return {
                    success: true,
                    data: response.data
                };
    ...
    async loginWithQR() {
        ...
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mijia$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mijiaAuth"].QRlogin();
...
const useAuthStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])()((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$middleware$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["persist"])((set)=>({
        ...
        login: (token, user, mijiaSession)=>{
            ...
            if (mijiaSession) {
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mijia$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mijiaAPI"].setSession(mijiaSession);
            }
        },
        logout: ()=>{
            set({
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mijia$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mijiaAPI"].setSession(null);
        }
    }), {
    name: 'auth-storage'
}));
const useDeviceStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])()((set, get)=>({
        devices: [],
        loading: false,
        error: null,
        fetchDevices: async ()=>{
            ...
            try {
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].getDevices();
                if (response.success && response.data) {
                    set({
        ...
        updateDevice: async (deviceId, properties)=>{
            try {
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].updateDevice(deviceId, properties);
                if (response.success) {
                    // Update local state
...
const LoginPage = ()=>{
    ...
    const { isAuthenticated, login } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"])();
    ...
    const [qrStatus, setQrStatus] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('idle');
    const [loginMethod, setLoginMethod] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('qr');
    ...
    const generateQR = async ()=>{
        ...
        try {
            var _response_data;
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].generateQR();
            if (response.success && ((_response_data = response.data) === null || _response_data === void 0 ? void 0 : _response_data.qrUrl)) {
                setQrCode(response.data.qrUrl);
                setQrStatus('idle');
                checkQRStatus();
            } else {
                setQrStatus('error');
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Không thể tạo mã QR');
            }
        } catch (e) {
            setQrStatus('error');
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Lỗi khi tạo mã QR');
        }
    };
    const checkQRStatus = async ()=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].checkQRStatus('');
            if (response.success) {
                var _response_data, _response_data1;
                if (((_response_data = response.data) === null || _response_data === void 0 ? void 0 : _response_data.status) === 'confirmed') {
                    setQrStatus('success');
                    ...
                    router.push('/dashboard');
                } else if (((_response_data1 = response.data) === null || _response_data1 === void 0 ? void 0 : _response_data1.status) === 'expired') {
                    setQrStatus('error');
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Mã QR đã hết hạn');
                } else {
                    // Continue checking
            ...
            setQrStatus('error');
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Lỗi khi kiểm tra trạng thái QR');
        }
    };
    const handleCredentialLogin = async (e)=>{
        ...
        setLoading(true);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].loginWithCredentials(credentials.username, credentials.password);
            if (response.success && response.data && typeof response.data === 'object' && 'token' in response.data && 'user' in response.data) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(response.error || 'Đăng nhập thất bại');
            }
        } catch (error) {
            console.error('Login error:', error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Lỗi khi đăng nhập');
        } finally{
            setLoading(false);
        }
    };
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$tabs$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TabsContent"], {
                                            ...
                                            children: [
                                                ...
                                                qrStatus === 'loading' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "text-center",
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                qrCode && qrStatus === 'idle' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                qrStatus === 'success' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "text-center",
                                                    children: [
                                                ...
                                                qrStatus === 'error' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "text-center",
                                                    children: [
...
_s(LoginPage, "qc5lhQqwOq9tboEmRMQqJM/YbHo=", false, function() {
    return [
...
//# sourceMappingURL=src_6d1dbb20._.js.map